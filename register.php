    ...
    <form method="POST" action="register.php">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone"
                ...
                placeholder="9200000000" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="location"
                ...
                placeholder="e.g., City, State" required>
        </div>

        <!-- ✅ NEW TASIL FIELD -->
        <div class="form-group">
            <label>Tasil:</label>
            <input type="text" class="form-control" name="tasil"
                value="<?php echo htmlspecialchars($_POST['tasil'] ?? ''); ?>"
                placeholder="Enter your tasil" required>
        </div>
